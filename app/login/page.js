...
const page = () => {
    ...
    const handleSendOtp = async () => {
        try {
            ...
            setOptSent(true)
            toast.success('OTP sent successfully', { duration: 5000, style: { border: '2px solid green', padding: '15px 20px'} })
        } catch (err) {
            toast.error("Please Enter Valid Phone Number", { duration: 5000, style: { border: '2px solid red', padding: '15px 20px'} })
        }
    }
    ...
    const handleOtpSubmit = async () => {
        try {
            ...
            toast.success('Logged in successfully', { duration: 5000, style: { border: '2px solid green', padding: '15px 20px'} })
