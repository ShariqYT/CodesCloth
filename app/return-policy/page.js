...
const ReturnPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto my-20 p-6 rounded-lg shadow-md">
        ...
        <p className="text-sm  mt-2">Effective Date: 11/07/2024</p>
        
        <h2 className="text-lg font-semibold  mt-4">Introduction</h2>
        <p className="text-base  mt-2">We want you to be satisfied with your purchase. If you are not completely happy with your order, you can return it under the conditions outlined below.</p>
        
        <h2 className="text-lg font-semibold  mt-4">Returns</h2>
        ...
        <h2 className="text-lg font-semibold  mt-4">Exchanges</h2>
        <p className="text-base mt-2">We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at codescloth.adamin@gmail.com</p>
        
        <h2 className="text-lg font-semibold  mt-4">Shipping</h2>
        <p className="text-base mt-2">You will be responsible for paying for your own shipping costs for returning your item. Shipping costs are non-refundable.</p>
        
        <h2 className="text-lg font-semibold  mt-4">Contact Us</h2>
        <ul className="list-disc list-inside text-base mt-2">Email:
