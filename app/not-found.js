...
const ErrorPage = () => {
    return (
        <section className="flex items-center justify-center w-full min-h-screen font-serif">
            <div className="row flex w-fit justify-center">
                <div className="col-sm-12 w-full text-center">
                    ...
                    <div className="contant_box_404 -mt-12">
                        ...
                        <Link href={'/'} className="link_404  py-2 px-4 rounded bg-purple-600 mt-5 inline-block">Go to Home</Link>
                    </div>
                </div>
            </div>
        </section>
