        ...
        <div className="pin mt-6 flex flex-col justify-center items-center md:items-start text-sm">
            <div className='flex gap-2'>
                <input
                    ...
                    className="w-fit bg-transparent p-2 border border-purple-700 outline-none rounded"
                    aria-label="Pincode Input"
                />
                <button
                    onClick={handlePin}
                    className="flex items-center justify-center gap-1 text-white bg-purple-700 border-0 py-2 px-6 focus:outline-none hover:bg-purple-900 rounded"
                    aria-live="assertive"
                    aria-busy={spin}
                >
                    {spin && (
                        <svg className='w-4 h-4 mr-2 animate-spin' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
