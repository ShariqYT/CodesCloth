    ...
    return (
        <div className="pin mt-6 flex flex-col justify-center items-center md:items-start text-sm">
            ...
            <div className='flex gap-2'>
                <input onChange={changePin} value={pin} min={0} type="number" id="pincode" name="pincode" placeholder="Enter your Pincode" className="w-fit bg-transparent p-2 border border-purple-700 outline-none rounded" />
