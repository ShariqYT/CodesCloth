...
const ShareButton = () => {
  ...
  return (
    <button
      onClick={handleShare}
      className="flex items-center border-2 border-purple-700 shadow-[0_0_30px_rgba(255,255,255,.6)] p-2 rounded-full"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-6 text-purple-700' fill="none">
