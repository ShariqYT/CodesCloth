        ...
        <div className="main-box border border-purple-700 rounded-xl pt-6 max-w-xl max-md:mx-auto md:max-w-full">
          <div className="flex flex-col md:flex-row md:items-center justify-between px-6 pb-6 border-b border-gray-200">
            ...
            <div className='flex items-center gap-10'>
              ...
              <button className="rounded-full py-4 px-5 font-semibold text-sm leading-7 text-white bg-purple-700 max-md:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-purple-800 hover:shadow-purple-600">
                Track Your Order
              </button>
            </div>
          </div>
