                ...
                <div className="mx-auto max-w-4xl">
                    ...
                    {orders && (<div className='flex items-center gap-2 justify-center flex-col'>
                        <svg className='w-12 h-12 mt-32 md:mt-52' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                            <path d="M11 22C10.1818 22 9.40019 21.6698 7.83693 21.0095C3.94564 19.3657 2 18.5438 2 17.1613C2 16.7742 2 10.0645 2 7M11 22L11 11.3548M11 22C11.6167 22 12.12 21.8124 13 21.4372M20 7V12" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" strokeLinejoin="round" />
                            ...
                            <path d="M5 12L7 13" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" strokeLinejoin="round" />
                            <path d="M16 4L6 9" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" strokeLinejoin="round" />
                        </svg>
