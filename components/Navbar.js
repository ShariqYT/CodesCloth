...
const MobileMenu = () => {
  ...
  return (
    <div className='md:hidden flex gap-2 items-center'>
      ...
      <div onClick={() => setIsOpen(!isOpen)} className={`${isDarkMode ? 'bg-[rgba(0,0,0,1)] !z-10 text-white' : 'bg-[rgba(255,255,255,1)] text-black'} ${isOpen ? 'translate-x-0' : '-translate-x-[1000px]'} w-full absolute top-20 border-2  border-purple-700 left-0 flex flex-col p-4 rounded-lg shadow-xl font-semibold  transform  transition-all duration-300 ease-in-out`}>
