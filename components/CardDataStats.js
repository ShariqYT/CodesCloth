...
const CardDataStats = ({
  ...
  return (
    <div className="rounded-lg border-2 w-full border-purple-700 px-7 py-6 shadow">
      ...
      <div className="mt-4 flex items-end justify-between">
        ...
        >
          ...
          {levelUp && (
            <svg
              className="fill-green-500 drop-shadow-[0_0_2px_rgba(0,0,0,.2)]"
              width="10"
              height="11"
              viewBox="0 0 10 11"
              fill="none"
          ...
          {levelDown && (
            <svg
              className="fill-red-500 drop-shadow-[0_0_2px_rgba(0,0,0,.2)]"
              width="10"
              height="11"
              viewBox="0 0 10 11"
              fill="none"
