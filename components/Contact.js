  ...
  return (
    <div className="min-h-screen mt-10" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        ...
        <div>
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-4 font-semibold text-white transition-all duration-200 ease-in-out rounded-lg hover:bg-purple-800 focus:outline-none bg-purple-700 focus:bg-purple-900 px-7"
            >
              Send Message
            </button>
          </form>
