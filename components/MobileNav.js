...
const MobileNav = () => {
    ...
    return (
        <div className={`md:hidden flex justify-between z-50 items-center px-5 py-1 sticky bottom-0 ${isDarkMode ? 'bg-[rgba(0,0,0,0.6)]' : 'bg-[rgba(255,255,255,0.4)]'} backdrop-blur ${isDarkMode ? 'shadow-[0_0_50px_rgba(255,255,255,0.3)]' : 'shadow-[0_0_30px_rgba(0,0,0,0.2)]'}`}>
